...
namespace Dufry.Comissoes.Domain.Entities.Validations
{
    public class ControleAcessoIsValidValidation : Validation<ControleAcesso>
    {
        public ControleAcessoIsValidValidation()
        {
            ...
            base.AddRule(new ValidationRule<ControleAcesso>(new ControleAcessoCodigoEmpresaAlternateLengthMustBeLowerThan20Spec(), ValidationMessages.ControleAcessoCodigoEmpresaAlternateLengthMustBeLowerThan2));
            ...
            base.AddRule(new ValidationRule<ControleAcesso>(new ControleAcessoCodigoSecundarioLengthMustBeLowerThan4Spec(), ValidationMessages.ControleAcessoCodigoSecundarioLengthMustBeLowerThan40));
