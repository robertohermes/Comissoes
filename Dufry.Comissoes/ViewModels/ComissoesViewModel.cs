...
namespace Dufry.Comissoes.ViewModels
{
    public class ComissoesViewModel
    {
        ...
        public IEnumerable<SelectListItem> ProdutoGruposDufrySelectListItem { get; set; }
        ...
        public ComissoesViewModel(IEnumerable<SelectListItem> colaboradoresSelectListItem, IEnumerable<SelectListItem> lojasSelectListItem, IEnumerable<SelectListItem> itensSelectListItem, IEnumerable<SelectListItem> tipobusinesesSelectListItem, IEnumerable<SelectListItem> cargosSelectListItem, IEnumerable<SelectListItem> aeroportosSelectListItem, IEnumerable<SelectListItem> subGruposDufrySelectListItem, IEnumerable<SelectListItem> produtoCategoriasSelectListItem, IEnumerable<SelectListItem> produtoGruposDufrySelectListItem)
        {
            ...
            ProdutoGruposDufrySelectListItem = produtoGruposDufrySelectListItem;
